...
func main() {
	...
	r.InitialState(resolver.State{Addresses: []resolver.Address{resolver.NewAddress("").WithAddr(":10001"), resolver.NewAddress("").WithAddr(":10002"), resolver.NewAddress("").WithAddr(":10003")}})
