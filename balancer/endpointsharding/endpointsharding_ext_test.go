...
func (s) TestEndpointShardingBasic(t *testing.T) {
	...
	mr.InitialState(resolver.State{
		Endpoints: []resolver.Endpoint{
			resolver.NewEndpoint(resolver.NewAddress(backend1.Address)),
			resolver.NewEndpoint(resolver.NewAddress(backend2.Address)),
		},
		ServiceConfig: sc,
	})
...
func (s) TestEndpointShardingReconnectDisabled(t *testing.T) {
	...
	mr.InitialState(resolver.State{
		Endpoints: []resolver.Endpoint{
			resolver.NewEndpoint(resolver.NewAddress(backend1.Address), resolver.NewAddress(backend2.Address)),
			resolver.NewEndpoint(resolver.NewAddress(backend3.Address)),
		},
		ServiceConfig: sc,
	})
...
func (s) TestEndpointShardingExitIdle(t *testing.T) {
	...
	mr.InitialState(resolver.State{
		Endpoints: []resolver.Endpoint{
			resolver.NewEndpoint(resolver.NewAddress(backend.Address)),
		},
		ServiceConfig: sc,
	})
