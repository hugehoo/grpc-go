...
func (s) TestPickFirst_ShuffleAddressList(t *testing.T) {
	...
	r.UpdateState(resolver.State{Endpoints: []resolver.Endpoint{
		resolver.NewEndpoint(addrs[0]),
		resolver.NewEndpoint(addrs[1]),
	}})
	if err := pickfirst.CheckRPCsToBackend(ctx, cc, addrs[0]); err != nil {
		t.Fatal(err)
	}
...
func (s) TestPickFirstLeaf_InterleavingIPV4Preferred(t *testing.T) {
	...
	ccState := balancer.ClientConnState{
		ResolverState: resolver.State{
			Endpoints: []resolver.Endpoint{
				resolver.NewEndpoint(resolver.NewAddress("1.1.1.1:1111")),
				resolver.NewEndpoint(resolver.NewAddress("2.2.2.2:2")),
				resolver.NewEndpoint(resolver.NewAddress("3.3.3.3:3")),
				// IPv4-mapped IPv6 address, considered as an IPv4 for
				// interleaving.
				resolver.NewEndpoint(resolver.NewAddress("[::FFFF:192.168.0.1]:2222")),
				resolver.NewEndpoint(resolver.NewAddress("[0001:0001:0001:0001:0001:0001:0001:0001]:8080")),
				resolver.NewEndpoint(resolver.NewAddress("[0002:0002:0002:0002:0002:0002:0002:0002]:8080")),
				resolver.NewEndpoint(resolver.NewAddress("[fe80::1%eth0]:3333")),
				resolver.NewEndpoint(resolver.NewAddress("grpc.io:80")), // not an IP.
			},
		},
	}
...
func (s) TestPickFirstLeaf_InterleavingIPv6Preferred(t *testing.T) {
	...
	ccState := balancer.ClientConnState{
		ResolverState: resolver.State{
			Endpoints: []resolver.Endpoint{
				resolver.NewEndpoint(resolver.NewAddress("[0001:0001:0001:0001:0001:0001:0001:0001]:8080")),
				resolver.NewEndpoint(resolver.NewAddress("[0001:0001:0001:0001:0001:0001:0001:0001]:8080")), // duplicate, should be ignored.
				resolver.NewEndpoint(resolver.NewAddress("1.1.1.1:1111")),
				resolver.NewEndpoint(resolver.NewAddress("2.2.2.2:2")),
				resolver.NewEndpoint(resolver.NewAddress("3.3.3.3:3")),
				resolver.NewEndpoint(resolver.NewAddress("[::FFFF:192.168.0.1]:2222")),
				resolver.NewEndpoint(resolver.NewAddress("[0002:0002:0002:0002:0002:0002:0002:0002]:2222")),
				resolver.NewEndpoint(resolver.NewAddress("[fe80::1%eth0]:3333")),
				resolver.NewEndpoint(resolver.NewAddress("grpc.io:80")), // not an IP.
			},
		},
	...
	ccState := balancer.ClientConnState{
		ResolverState: resolver.State{
			Endpoints: []resolver.Endpoint{
				...
				resolver.NewEndpoint(resolver.NewAddress("[0002:0002:0002:0002:0002:0002:0002:0002]:8080")),
				resolver.NewEndpoint(resolver.NewAddress("[fe80::1%eth0]:3333")),
				resolver.NewEndpoint(resolver.NewAddress("example.com:80")), // not an IP.
			},
		},
	}
	if err := bal.UpdateClientConnState(ccState); err != nil {
