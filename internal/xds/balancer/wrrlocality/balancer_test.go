...
func (s) TestUpdateClientConnState(t *testing.T) {
	...
	ep1 := resolver.Endpoint{Addresses: []resolver.Address{resolver.NewAddress("locality-1")}}
	...
	ep2 := resolver.Endpoint{Addresses: []resolver.Address{resolver.NewAddress("locality-2")}}
