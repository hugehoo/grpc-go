						...
						Localities: []xdsresource.Locality{
							{ID: clients.Locality{
								...
								Endpoints: []xdsresource.Endpoint{
									{
										ResolverEndpoint: resolver.Endpoint{Addresses: []resolver.Address{resolver.NewAddress("localhost:8081")}},
...
func (s) TestAggregateCluster(t *testing.T) {
	...
	dnsR.UpdateState(resolver.State{
		Endpoints: []resolver.Endpoint{
			{Addresses: []resolver.Address{resolver.NewAddress("127.0.0.1:8081")}},
			{Addresses: []resolver.Address{resolver.NewAddress("[::1]:8081")}},
		},
	})
						...
						EDSUpdate: &xdsresource.EndpointsUpdate{
							Localities: []xdsresource.Locality{
								{ID: clients.Locality{
									...
									Endpoints: []xdsresource.Endpoint{
										{
											ResolverEndpoint: resolver.Endpoint{Addresses: []resolver.Address{resolver.NewAddress("localhost:8080")}},
											HealthStatus:     xdsresource.EndpointHealthStatusUnknown,
											Weight:           1,
										},
									},
					...
					EndpointConfig: &xdsresource.EndpointConfig{
						EDSUpdate: &xdsresource.EndpointsUpdate{
							Localities: []xdsresource.Locality{{
								...
								Endpoints: []xdsresource.Endpoint{{
									ResolverEndpoint: resolver.Endpoint{Addresses: []resolver.Address{resolver.NewAddress("localhost:9090")}},
									HealthStatus:     xdsresource.EndpointHealthStatusUnknown,
									Weight:           1,
								}},
								Weight: 1,
					...
					EndpointConfig: &xdsresource.EndpointConfig{
						EDSUpdate: &xdsresource.EndpointsUpdate{
							Localities: []xdsresource.Locality{{
								...
								Endpoints: []xdsresource.Endpoint{{
									ResolverEndpoint: resolver.Endpoint{Addresses: []resolver.Address{resolver.NewAddress("localhost:10080")}},
									HealthStatus:     xdsresource.EndpointHealthStatusUnknown,
									Weight:           1,
								}},
								Weight: 1,
